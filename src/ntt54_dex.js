//IT WORKS BUT HAVE TO CHANGE THE ADDRESS TO
...
async function main () {
    ...
    const targetDot = parseUnits("10", 10);
    ...
    await instance.swapWithExactTarget(path2, targetAusd, expectedSupply2.add(parseUnits("10", 10)));
